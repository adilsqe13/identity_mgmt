        ...
        <div class="modal-dialog center-100 box" role="document">
            <div class="modal-content">
                <div class="modal-header border-0">
                    ...
                    <a href="<?= base_url('admin/user-management/user_profile?user_id=' . $user->id) ?>"><i class="fas fa-times fa-lg p-2" style="color: black"></i></a>
                </div>
                <div class="modal-body">
                    <?php 
                    $flash_id = $this->session->flashdata('user_id');
                    $flash_f_name = $this->session->flashdata('f_name');
                    $flash_email = $this->session->flashdata('email');
                    $flash_mobile = $this->session->flashdata('mobile');
                    ?>
                    <form action=<?php echo base_url("Admin/EditUserProfile/edit_user") ?> method="post" enctype="multipart/form-data">
                        <input type="hidden" id="user_id" name="user_id" value="<?php echo isset($flash_id) ? $flash_id :  $user->id ?>"></input>
                        <div class="mb-3">
                            <label for="name" class="form-label ">Name</label>
                            <input type="text" class="form-control" name="f_name" value='<?php echo isset($flash_f_name) ? $flash_f_name :  $user->f_name ?>' required />
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label ">Email</label>
                            <input type="email" class="form-control" name="email" value='<?php echo isset($flash_email) ? $flash_email :  $user->email ?>' required />
                            <!-- Error Msg Display -->
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control" pattern="[0-9]{10}" name="mobile" value='<?php echo isset($flash_mobile) ? $flash_mobile : $user->mobile ?>' required />
                            <!-- Error Msg Display -->
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                        <span class="h3"><a href="<?= base_url('Admin/user-management')?>" class="btn m-0"><i class="fas fa-arrow-left"></i></a></span>
                            <span class="h3 m-0">Profile</span>
                        </div><!-- /.col -->
                                ...
                                <div class="card-body box-profile">
                                    ...
                                    <ul class="list-group list-group-unbordered mt-5">
                                        <li class="list-group-item">
                                            <b>Name:</b> <a class="float-right"><?= $user->f_name ?></a>
                                        </li>
                                        <li class="list-group-item">
                                    ...
                                    <a href="<?= base_url('admin/user-management/edit_user?user_id=' . $user->id) ?>" class="btn btn-info btn-block mt-2">
                                        <div class="row">
                                            <div class="col-7 dfjeac"><span style="font-size: 22px;" class="mx-1 bold">Edit</span></div>
                                            <div class="col-5 dfjsac"><i class="fas fa-edit"></i></div>
                                        </div>
                                    </a>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(function() {
            <?php if ($this->session->flashdata('delete_success')) : ?>
                Toast.fire({
                    icon: 'success',
                    title: '<?php echo $this->session->flashdata('delete_success'); ?>'
                });
            <?php endif; ?>
        });
        $(function() {
            <?php if ($this->session->flashdata('add_user_success')) : ?>
                Toast.fire({
                    icon: 'success',
                    title: '<?php echo $this->session->flashdata('add_user_success'); ?>'
                });
            <?php endif; ?>
        });
    </script>
