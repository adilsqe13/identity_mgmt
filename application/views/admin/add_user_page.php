        ...
        <div class="modal-dialog center-100 box" role="document">
            <div class="modal-content">
                <div class="modal-header border-0">
                    <h3 class="modal-title" id="addUserModalLabel">Create a user</h3>
                        <a href="<?= base_url('Admin/UserManagement')?>"><i class="fas fa-times fa-lg p-2" style="color: black"></i></a>
                </div>
                <div class="modal-body">
                    <form action=<?php echo base_url("Admin/AddUser/add_user") ?> method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="name" class="form-label ">Name</label>
                            <input type="text" class="form-control"  name="f_name" value='<?php echo $this->session->flashdata('f_name'); ?>' required />
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label ">Email</label>
                            <input type="email" class="form-control"  name="email" value='<?php echo $this->session->flashdata('email'); ?>' required />
                            <!-- Error Msg Display -->
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control"  pattern="[0-9]{10}" name="mobile" value='<?php echo $this->session->flashdata('mobile'); ?>' required />
                            <!-- Error Msg Display -->
                ...
                <div class="modal-footer border-0">
                    <input type="submit" name="add_user" value="Add" style="width:17%" class="btn btn-md btn-warning"></input>
                </div>
                </form>
            </div>
        </div>
    ...
    <script>
         $(function() {
            <?php if ($this->session->flashdata('add_user_error')) : ?>
                Toast.fire({
                    icon: 'error',
                    title: '<h5><?php echo $this->session->flashdata('add_user_error'); ?></h5>'
                });
            <?php endif; ?>
        });
    </script>
