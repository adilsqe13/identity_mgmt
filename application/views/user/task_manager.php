...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            <div class="col-5 p-0 dfjsac"><button onclick='archiveTask(<?php echo $task->id ?>)' class="btn btn-sm " title="Archive"><i class="fas fa-archive fa-2x" style="color: gray; padding:0px"></i></button></div>
                                        </div>
                                    </td>
                                </tr>
                            <?php
        ...
        <script>
            ...
            function confirmDelete($task_id) {
                if (confirm("Do you want to delete this user ?")) {
                    window.location.href = baseUrl + 'User/TaskManager/delete_task?task_id=' + $task_id;
                }
            }
            function archiveTask($task_id) {
                if (confirm("Do you want to archive ?")) {
                    window.location.href = baseUrl + 'User/ArchiveTask/archive_task?task_id=' + $task_id;
                }
            }
        ...
        <script>
            ...
            $(function() {
                <?php if ($this->session->flashdata('task_added_success')) : ?>
                    Toast.fire({
                        icon: 'success',
                        title: '<h6><?php echo $this->session->flashdata('task_added_success'); ?></h6>'
                    });
                <?php endif; ?>
            });
            $(function() {
            ...
            $(function() {
                <?php if ($this->session->flashdata('task_deleted_success')) : ?>
                    Toast.fire({
                        icon: 'success',
                        title: '<?php echo $this->session->flashdata('task_deleted_success'); ?>'
                    });
                <?php endif; ?>
            });
            $(function() {
                <?php if ($this->session->flashdata('task_archived_success')) : ?>
                    Toast.fire({
                        icon: 'success',
                        title: '<?php echo $this->session->flashdata('task_archived_success'); ?>'
                    });
                <?php endif; ?>
            });
        </script>
