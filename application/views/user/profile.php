        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <span class="h3"><a href="<?= base_url('dashboard')?>" class="btn m-0"><i class="fas fa-arrow-left"></i></a></span>
                            <span class="m-0 h3">Profile</span>
                        </div><!-- /.col -->
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <div class="container mt-4">
                                <div class="row">
                                    <div class="col-5 dfjeac bold">NAME:</div>
                                    <div class="col-7 text-info dfjsac border-0 list-group-item"><?= $user->f_name ?></div>
                                </div>
                                <div class="row">
                                    <div class="col-5 dfjeac bold">EMAIL:</div>
                                    <div class="col-7 text-info dfjsac border-0 list-group-item"><?= $user->email ?></div>
                                </div>
                                <div class="row">
                                    <div class="col-5 dfjeac bold">MOBILE:</div>
                                    <div class="col-7 text-info dfjsac border-0 list-group-item"><?= $user->mobile ?></div>
                                </div>
                                <div class="row">
                                    <div class="col-5 dfjeac bold">DOB:</div>
                                    <div class="col-7 text-info dfjsac border-0 list-group-item"><?= $user->dob ? $user->dob : '----' ?></div>
                                </div>
                                <div class="row">
                                    <div class="col-5 dfjeac bold">ADDRESS:</div>
                                    <div class="col-7 text-info dfjsac border-0 list-group-item"><?= $user->address ? $user->address : '----' ?></div>
                                </div>
                            </div>

                            <a href="<?= base_url('dashboard/profile/edit_profile') ?>" class="btn btn-info btn-block mt-2">
                                <div class="row">
                                    <div class="col-6 dfjeac"><span style="font-size: 22px;" class="mx-1 bold">Edit</span></div>
                                    <div class="col-6 dfjsac"><i class="fas fa-edit"></i></div>
                                </div>
                            </a>
                        </div>
                    </div>
